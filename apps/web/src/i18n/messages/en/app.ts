...
export const enApp: Record<keyof typeof deApp, string> = {
  ...
  "app.copilot.personalEyebrow": "Your own copilot",
  ...
  "app.evidence.customTitle": "Custom metrics",
  "app.evidence.customIntro": "Add personal scales from 1 to 10. The technical key remains permanently unchanged.",
  "app.evidence.customKey": "Technical key",
  "app.evidence.customKeyHint": "Lowercase letters, numbers, and underscores; starts with a letter.",
  "app.evidence.customLabel": "Display name",
  "app.evidence.customCreate": "Create metric",
  "app.evidence.customRetire": "retire",
  "app.evidence.customInvalid": "Enter a valid technical key and a display name.",
  "app.evidence.customError": "The custom metric could not be changed.",
