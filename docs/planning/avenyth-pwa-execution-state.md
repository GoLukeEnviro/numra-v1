...
- **VERIFIED_MAIN_SHA:** `4b0926cdc9899cf652279d5ba909b05da68b3835` (PR #184 — behaviour-changing merge; full CI set incl. the required `sast` gate green, 16/16 checks)
...
| PWA-10 checks (a11y/perf/install/offline) | measured, three findings | `PWA10-CHECKS-20260921c.json`: a11y app desktop+mobile PASS, login desktop PASS, login mobile 1 violation; perf TTFB 17/14 ms; manifest+SW+icons 200; offline navigation deliberately network-only. Issues #185 (h1), #186 (offline decision), #187 (CORS allowlist/release checklist) |
